        ...
        <div class="col-12 col-md-12 col-xl-12">
            <div class="card border-secondary">
                <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-light btn-sm" id="btn_agregar_residencial" data-bs-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-secondary">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" id="btn_eliminar_residencial">Eliminar</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    if (data.msgError != null) {
                        ...
                        if (accion == 1 || accion == 2) {
                            ...
                            var nuevaFilaDT = [row.id,
                                ...
                                '</button> ' +
                                '<button type="button" class="btn btn-danger btn-icon btn-xs" data-bs-toggle="modal" data-bs-target=".modal_eliminar_residencial" ' +
                                'data-id="' + row.id + '" ' +
                                'data-nombre="' + row.nombre + '" ' +
                                'data-descripcion="' + row.descripcion + '">' +
